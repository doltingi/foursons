		...
		padding-bottom : 0px;
			...
			<div class="well well-foursons">
				<form class="form-inline" role="form" id="reserveForm" name="reserveForm" action="pickdate.php" method="post">
						...
						<div class="col-md-2 col-md-offset-2">
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">
									<h1><span class="ultra" id="lbl_price"></span><span style="vertical-align:top;">*</span></h1>
									<input type="hidden" name="price" id="price" class="form-control">
								</div>
								<div class="col-md-12 col-sm-5 col-xs-5">
									<span class="fine_print pull-right">*plus applicable taxes</span>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-2 col-md-offset-5 col-xs-12 col-sm-12">
